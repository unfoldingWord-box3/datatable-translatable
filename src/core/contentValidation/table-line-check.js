...
/**
 * For checking a single TSV row
 * @param {string} line
 * @param {string} BBB - book code
 * @param {string} C - chapter
 * @param {string} V - verse
 * @param givenRowLocation
 * @param optionalCheckingOptions
 * @return {Promise<{noticeList: []}>}
 */
